<header class="header header-layout2">
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <!-- <li class="nav__item">
                <a href="#" class="nav__item-link">Doctors</a>
            </li> /.nav-item 
            <li class="nav__item">
                <a href="#" class="nav__item-link">Blog</a>
            </li><-- /.nav-item 
            <li class="nav__item">
                <a href="#" class="nav__item-link">Shop</a>
            </li>/.nav-item -->
            <li class="nav__item">
            <a href="user/login.php" class="nav__item-link">Login</a>
            </li><!-- /.nav-item -->
            <li class="nav__item">
        ...
        <a href="./user/login.php" class="btn btn__primary btn__rounded ml-30">
            <i class="icon-user"></i>
            <span>&nbsp; Sign in</span>
        </a>
        </div>
