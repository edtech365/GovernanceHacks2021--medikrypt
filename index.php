...
<head>
  ...
  <meta name="description" content="MediKrypt - An all in One Health Solution">
            ...
            <div class="row align-items-center">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-8 offset-xl-2">
                <div class="slide__content">
                  <h2 class="slide__title color-white">A single Health <br>Solution System</h2>
        ...
        <div class="slide-item align-v-h">
          ...
          <div class="container">
            <div class="row align-items-center">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-8 offset-xl-2">
                <div class="slide__content">
                  <h2 class="slide__title color-white">MediKrypt Platform <br> for Health Solutions</h2>
                  <p class="slide__desc color-white">The health and well-being of our patients and their health care
                    team will
                    always be our priority, so we follow the best practices for cleanliness.</p>
                  <div class="d-flex flex-wrap justify-content-center align-items-center">
